...
const PropertyTenants = () => {
  ...
  const handleDownloadAgreement = (leaseId: number) => {
    // Handle download logic here
    console.log(`Download agreement for lease: ${leaseId}`);
  };
                    ...
                    <TableRow key={lease.id} className="h-24">
                      ...
                      <TableCell>
                        <button
                          ...
                          onClick={() => handleDownloadAgreement(lease.id)}
                        >
